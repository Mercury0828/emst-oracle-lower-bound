...
active-cover packing inequality collapses the per-scale costs to $\Otil(\sqrt K)$ on a $K$-cell support.
With a clipped death-time sampler for the bulk and a regularization that routes the heavy tail through a
snapped grid, balancing at $K=\Theta(n^{2/3})$ gives the $n^{1/3}$ rate.
